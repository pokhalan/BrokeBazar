<footer id="footer"><!--Footer-->
    <div class="footer-top">
        <div class="container">
            <div class="row">
                <div class="col-sm-2">
                    <div class="logo">
                        <h2><span>Broke</span>-Bazaar</h2>
                        <p>Marketplace for student from student</p>
                    </div>
                </div>
                <div class="col-sm-7">
                    {{--<div class="col-sm-3">--}}
                ...
                <div class="col-sm-3">
                    <div class="address">
                        ...
                        <p>921 S 8th Ave Pocatello, ID(Idaho)</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © 2020 Broke Bazaar. All rights reserved.</p>
